  ...
  const lineArtDivs = [
    {
      ...
      text: "Superhero",
      subImages: [
        { src: "/dd/a1.svg", icon: "/d/a1.svg", text: "Spiderman" },
        { src: "/dd/a2.svg", icon: "/d/a2.svg", text: "Superman" },
        { src: "/dd/a3.svg", icon: "/d/a3.svg", text: "black widow" },
        { src: "/dd/a4.svg", icon: "/d/a4.svg", text: "Supergirl" },
      ],
    },
    {
      src: "/a2.svg",
      text: "Space",
      subImages: [
        { src: "/h1.svg", icon: "/hh1.svg", text: "Astroid" },
        { src: "/h2.svg", icon: "/hh2.svg", text: "UFO" },
        { src: "/h3.svg", icon: "/hh3.svg", text: "Planet" },
        { src: "/h4.svg", icon: "/hh4.svg", text: "Astronaut" },
      ],
    },
    {
      src: "/a3.png",
      ...
      subImages: [
        ...
        { src: "/dd/c3.svg", icon: "/d/c3.svg", text: "Airplane" },
    ...
    },
    {
      ...
      text: "Anime",
      subImages: [
        { src: "/dd/b1.svg", icon: "/d/b1.svg", text: "Anime guy" },
        { src: "/dd/b2.svg", icon: "/d/b2.svg", text: "Anime guy" },
        { src: "/dd/b3.svg", icon: "/d/b3.svg", text: "Anime girl" },
        { src: "/dd/b4.svg", icon: "/d/b4.svg", text: "Anime girl" },
      ],
    },
  ];
